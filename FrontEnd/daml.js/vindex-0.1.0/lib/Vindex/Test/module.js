...
exports.Ctx = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({i1: damlTypes.Party.decoder, worker: damlTypes.Party.decoder, agent: damlTypes.Party.decoder, ip: damlTypes.ContractId(Vindex.InvestorParty).decoder, proj: damlTypes.ContractId(Vindex.Project).decoder, }); }),
