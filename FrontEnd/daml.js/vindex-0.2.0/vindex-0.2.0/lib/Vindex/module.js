...
var Vindex_Token = require('../Vindex/Token/module');
...
exports.Application = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:Application',
...
damlTypes.registerTemplate(exports.Application, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
...
exports.ApprovePlan = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      ...
      commitmentHoldingCid: jtv.Decoder.withDefault(null, damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).decoder),
    });
  }),
  encode: function (__typed__) {
    return {
      actor: damlTypes.Party.encode(__typed__.actor),
      commitmentHoldingCid: damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).encode(__typed__.commitmentHoldingCid),
    };
  },
};
...
exports.AssetVault = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:AssetVault',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
        ...
        holdingCid: jtv.Decoder.withDefault(null, damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).decoder),
      });
    }),
    encode: function (__typed__) {
      return {
        ...
        holdingCid: damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).encode(__typed__.holdingCid),
      };
    },
    Archive: {
    ...
    BackWithToken: {
      template: function () { return exports.AssetVault; },
      choiceName: 'BackWithToken',
      argumentDecoder: damlTypes.lazyMemo(function () {
        return exports.BackWithToken.decoder;
      }),
      argumentEncode: function (__typed__) { return exports.BackWithToken.encode(__typed__); },
      resultDecoder: damlTypes.lazyMemo(function () {
...
damlTypes.registerTemplate(exports.AssetVault, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);

exports.BackWithToken = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      holding: damlTypes.ContractId(Vindex_Token.TokenHolding).decoder,
    });
  }),
  encode: function (__typed__) {
    return {
      holding: damlTypes.ContractId(Vindex_Token.TokenHolding).encode(__typed__.holding),
    };
  },
};
...
exports.GovernanceProposal = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:GovernanceProposal',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.GovernanceProposal, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);

exports.InvestorInvite = damlTypes.assembleTemplate(
  {
    templateId: '#vindex:Vindex:InvestorInvite',
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:InvestorInvite',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.InvestorInvite, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);

exports.InvestorParty = damlTypes.assembleTemplate(
  {
    templateId: '#vindex:Vindex:InvestorParty',
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:InvestorParty',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.InvestorParty, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
...
exports.MilestoneReview = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:MilestoneReview',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.MilestoneReview, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
...
exports.PlanningMandate = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:PlanningMandate',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.PlanningMandate, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);

exports.Project = damlTypes.assembleTemplate(
  {
    templateId: '#vindex:Vindex:Project',
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:Project',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.Project, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);

exports.ProjectPosting = damlTypes.assembleTemplate(
  {
    templateId: '#vindex:Vindex:ProjectPosting',
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:ProjectPosting',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.ProjectPosting, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
...
exports.Settlement = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:Settlement',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.Settlement, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
...
exports.SetupAndPost = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      ...
      eligibleWorkers: damlTypes.List(damlTypes.Text).decoder,
      publicParty: damlTypes.Party.decoder,
      holdingCidOpt: jtv.Decoder.withDefault(null, damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).decoder),
    });
  }),
  encode: function (__typed__) {
    return {
      ...
      eligibleWorkers: damlTypes.List(damlTypes.Text).encode(__typed__.eligibleWorkers),
      publicParty: damlTypes.Party.encode(__typed__.publicParty),
      holdingCidOpt: damlTypes.Optional(damlTypes.ContractId(Vindex_Token.TokenHolding)).encode(__typed__.holdingCidOpt),
    };
  },
};
...
exports.WorkPlan = damlTypes.assembleTemplate(
  {
    ...
    templateIdWithPackageId: '#d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600:Vindex:WorkPlan',
    keyDecoder: jtv.constant(undefined),
    keyEncode: function () { throw 'EncodeError'; },
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
...
damlTypes.registerTemplate(exports.WorkPlan, ['d15c40d824c1c6453570505947e3f5044dde237edcf81a4a3bcc443e55d88600', '#vindex']);
